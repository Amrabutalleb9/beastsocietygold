# DNS & email checklist — beastsocietygold.com

When `beastsocietygold.com` uses **Cloudflare DNS**, add records per your mail host and ESP. Examples below are templates—replace includes with your provider values.
...
`v=DMARC1; p=none; pct=100; rua=mailto:contact@beastsocietygold.com; fo=1`
